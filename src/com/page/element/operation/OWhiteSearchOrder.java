...
public class OWhiteSearchOrder extends OperationTicketBase {
	...
	public void whiteDataInput(WhiteSearchOrderData orderData) {
		...
		Utility.selectDropDownListPerSpreadSheet(driver, "//ul[@id='id_startCity_listbox']/li/span",
				orderData.startCity, Utility.airport);
		endCity.sendKeys(orderData.endCity);
		Utility.selectDropDownListPerSpreadSheet(driver, "//ul[@id='id_endCity_listbox']/li/span", orderData.endCity,
				Utility.airport);
